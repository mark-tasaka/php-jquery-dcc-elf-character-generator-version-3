...
<html>
<head>
<title>Launch Page: Dungeon Crawl Classics Elf Character Generator Version 3</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Dungeon Crawl Classics Elf Character Generator Version 3" class="image" /></h1>
        ...
        <p><a href="https://www.oldschooladventures.org/dcc/elf/"  class="text_link" target="_blank"><span class="bold">Dwarves, Warriors & Mighty Deeds: A DCC Fan Site</span></a></p>

        <p><a href="https://www.tasaka-games.com/dcc/more/classes/elf/"  class="text_link" target="_blank"><span class="bold">Fantastic Adventures and the Distgruntled Gong Farmer: A DCC Adventure Module</span></a></p>
        ...
        <form action="" id ="ElfFormV3"  target="_blank" method="post">
    ...
    <div id="characterNameV3">
            ...
            <span id="characterElfNameV3"> <input type="text" name="theCharacterName" value="" class="nameBox"></span>
        ...
        <br/>
            ...
            <span class="formIputDescription">Armour:</span>	
			  <select id="armourV3" name="theArmour" class="alignmentBox">			
				...
				<option value="5"  selected>Mithril scale mail</option>
				<option value="6">Mithril chainmail armour</option>
				<option value="7">Mithril banded mail armour</option>
				<option value="8">Mithril half-plate armour</option>
				<option value="9">Mithril full plate armour</option>
			  </select>
        ...
        <div class="formIputDescription">
           <span class="footnote3"><input type="checkbox" id="checkBoxShieldV3" value="1" name="theCheckBoxShield">Add Shield</span>
           </div>
           <br/>
    ...
    <br/>
        ...
        $("#generate_charactersWarriorV3").click(function(){
         ...
         $("#ElfFormV3").attr('action', "character3/dccElf.php");
